...
import 'schema/products_2_record.dart';
...
export 'schema/products_2_record.dart';
...
/// Functions to query Products2Records (as a Stream and as a Future).
Future<int> queryProducts2RecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      Products2Record.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<Products2Record>> queryProducts2Record({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      Products2Record.collection,
      Products2Record.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<Products2Record>> queryProducts2RecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
