                          ...
                          children: [
                                              ...
                                              await Navigator.push(
                                                ...
                                                PageTransition(
                                                  ...
                                                  child:
                                                    ...
                                                    tag: valueOrDefault<String>(
                                                      additionalImagesItem,
                                                      'https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/projects/sample-app-property-finder-834ebu/assets/uxii7iwtqpy8/emptyAvatar@2x.png' '$additionalImagesIndex',
                                                    ),
                                                    useHeroAnimation: true,
                                                  ),
                                                ),
                            ...
                            if (widget.productRef?.owner != null)
                              Padding(
                                padding: const EdgeInsetsDirectional.fromSTEB(
                                    16.0, 10.0, 16.0, 0.0),
                                child: FutureBuilder<RestaurantsRecord>(
                                  future: RestaurantsRecord.getDocumentOnce(
                                      widget.productRef!.restaurant!),
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  if (FFAppState()
                                    ...
                                    FFButtonWidget(
                                      onPressed: () async {
                                        context.pushNamed('cart_Details');
                                      },
                                      text: 'Payement',
                                      options: FFButtonOptions(
                                        height: 60.0,
                                                            ...
                                                            child:
                                                              ...
                                                              tag:
                                                                  valueOrDefault<
                                                                      String>(
                                                                additionalImagesItem,
                                                                'https://images.unsplash.com/photo-1606107557195-0e29a4b5b4aa?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHw1fHxzaG9lfGVufDB8fHx8MTcwMjU3ODgzMXww&ixlib=rb-4.0.3&q=80&w=400' '$additionalImagesIndex',
                                                              ),
                                                              useHeroAnimation:
                                                                  true,
                                                            ),
