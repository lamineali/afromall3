...
import 'edit_property1_copy_model.dart';
export 'edit_property1_copy_model.dart';

class EditProperty1CopyWidget extends StatefulWidget {
  const EditProperty1CopyWidget({
    super.key,
    this.propertyRef,
  });
  ...
  @override
  State<EditProperty1CopyWidget> createState() =>
      _EditProperty1CopyWidgetState();
}

class _EditProperty1CopyWidgetState extends State<EditProperty1CopyWidget> {
  late EditProperty1CopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditProperty1CopyModel());
                          ...
                          InkWell(
                            ...
                            onTap: () async {
                              await showModalBottomSheet(
                                ...
                                barrierColor: const Color(0xB316202A),
                                context: context,
                                builder: (context) {
                                  return Padding(
