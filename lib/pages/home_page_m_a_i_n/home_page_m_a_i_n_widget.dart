...
class HomePageMAINWidget extends StatefulWidget {
  ...
  final RestaurantsRecord? dddd;
  final DocumentReference? categorie;
  final CategorieRecord? ff;
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          mainAxisAlignment: MainAxisAlignment.start,
                          children: [
                            StreamBuilder<CategorieRecord>(
                              stream: CategorieRecord.getDocument(
                                  widget.categorie!),
                              builder: (context, snapshot) {
                                ...
                                final textCategorieRecord = snapshot.data!;

                                return Text(
                                  textCategorieRecord.nom,
                              ...
                              builder: (context, snapshot) {
                                ...
                                return Text(
                                  '${valueOrDefault<String>(
                                    textCount.toString(),
                                    '1',
                                  )} commerces dans cette categorie',
                                  style: FlutterFlowTheme.of(context)
                                      .titleSmall
                                      .override(
                                        fontFamily: 'Urbanist',
          ...
          Expanded(
            child: StreamBuilder<List<RestaurantsRecord>>(
              ...
              builder: (context, snapshot) {
                ...
                List<RestaurantsRecord> listBgRestaurantsRecordList =
                    snapshot.data!;
                    ...
                    builder: (context) {
                      if (MediaQuery.sizeOf(context).width <= 1271.0) {
                        return Builder(
                          builder: (context) {
                            final listBgVar =
                                listBgRestaurantsRecordList.toList();
                                                                          ...
                                                                          children:
                                                                            ...
                                                                            Row(
                                                                              ...
                                                                              children: [
                                                                                Flexible(
                                                                                  child: Text(
                                                                                    listBgVarItem.description.maybeHandleOverflow(maxChars: 50),
