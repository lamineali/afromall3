...
import 'home_page_m_a_i_n_copy2_model.dart';
export 'home_page_m_a_i_n_copy2_model.dart';

class HomePageMAINCopy2Widget extends StatefulWidget {
  const HomePageMAINCopy2Widget({
    super.key,
    this.dddd,
  });
  ...
  @override
  State<HomePageMAINCopy2Widget> createState() =>
      _HomePageMAINCopy2WidgetState();
}

class _HomePageMAINCopy2WidgetState extends State<HomePageMAINCopy2Widget>
    with TickerProviderStateMixin {
  late HomePageMAINCopy2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomePageMAINCopy2Model());
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Padding(
                        padding:
                            const EdgeInsetsDirectional.fromSTEB(0.0, 2.0, 10.0, 0.0),
                        child: Row(
                          mainAxisSize: MainAxisSize.max,
