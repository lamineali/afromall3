...
import 'home_page_m_a_i_n_epicerie_model.dart';
export 'home_page_m_a_i_n_epicerie_model.dart';

class HomePageMAINEpicerieWidget extends StatefulWidget {
  const HomePageMAINEpicerieWidget({
    super.key,
    this.dddd,
  });
  ...
  @override
  State<HomePageMAINEpicerieWidget> createState() =>
      _HomePageMAINEpicerieWidgetState();
}

class _HomePageMAINEpicerieWidgetState extends State<HomePageMAINEpicerieWidget>
    with TickerProviderStateMixin {
  late HomePageMAINEpicerieModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomePageMAINEpicerieModel());
            ...
            child: StreamBuilder<List<ProductsRecord>>(
              stream: queryProductsRecord(
                queryBuilder: (productsRecord) => productsRecord
                    .where(
                      'category',
                      isEqualTo: 'epicerie' != '' ? 'epicerie' : null,
                    )
