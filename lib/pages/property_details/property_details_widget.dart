...
class PropertyDetailsWidget extends StatefulWidget {
  ...
  final ProductsRecord? propertyRef;
                      ...
                      children: [
                        Expanded(
                          child: Padding(
                            ...
                            child: Text(
                              valueOrDefault<String>(
                                widget.propertyRef?.description,
                                'Pas de description',
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodySmall
                            ...
                            child: Builder(
                              builder: (context) {
                                final additionalImages =
                                    (widget.propertyRef?.images.toList() ??
                                            [])
                                        .take(4)
                                        .toList();
              ...
              child: Row(
                ...
                children: [
                  ...
                  FFButtonWidget(
                    onPressed: () async {
                      // add_itemToCart
                      FFAppState().addToMyCart(widget.propertyRef!.reference);
                      FFAppState().addToMyCartSummary(valueOrDefault<double>(
                        widget.propertyRef?.price,
                        0.0,
                      ));
                      FFAppState().update(() {});
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          content: Text(
                            'Cet article est ajouté au panier avec succées.',
                            style: FlutterFlowTheme.of(context)
                                .labelSmall
                                .override(
                                  fontFamily: 'Poppins',
